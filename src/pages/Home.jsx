                ...
                <Container>
                    <div className="flex flex-col md:flex-row md:my-14 items-center justify-around">
                        ...
                        <div className='md:w-[40%] flex flex-col items-center md:items-start '>
                            <h1 className=' text-3xl md:text-[52px] lg:text-[72px] hero-heading md:text-left text-center' >Welcome to  <span className='gradient-text' >BlogIt!</span>  </h1>
                            <p className='md:text-left mt-6 text-center px-5 md:px-0'>Your hub for interesting reads, insights, and more. Start your journey into the world of BlogIt. Happy Blogging!</p>
                            <Button 
